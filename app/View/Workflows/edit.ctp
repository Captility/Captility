...
<ul class="timeline workflow-task-list">
    ...
    <? if (isset($this->request->data['Task'])) foreach ($this->request->data['Task'] as $i => $task): ?>
        ...
        <li class="task">
            <div class="timeline-badge workflow-task <? echo $classes[$i % sizeof($classes)] ?>"><span
            ...
            <div class="timeline-panel">
                <div class="timeline-heading">
                    ...
                    <div class="task-name-field task-edit">
                        ...
                        <div class="task-id-field task-edit">
                            <?php echo $this->Form->input('Task.' . $i . '.task_id', array('class' => 'form-control', 'placeholder' => 'Workflow Id'));?>
                        </div>
                    </div>
...
<div class="col-md-3 column">
    <div class="actions">
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                <h3 class="panel-title">
                    <span class="glyphicon glyphicon-link"></span><?php echo __('Captures');?></h3>
            </div>
            <div class="panel-body">
                <ul class="nav nav-pills nav-stacked">
