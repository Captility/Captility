<? $this->Breadcrumbs->addCrumb('<span class="glyphicon glyphicon-facetime-video"></span>'.__('Event Types'), array('action' => 'index')); ?><?php $this->Breadcrumbs->addCrumb(__('Admin Edit Event Type'), '#', array('class' => 'active')); ?>
<!--<div class=" form">-->
...
<div class="row">
    ...
    <div class="col-md-11 column">
        <div class="page-header">
            <h1><?php echo __('Admin Edit Event Type'); ?></h1>
        </div>
    </div>
</div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>'.__('Delete'), array('action' => 'delete', $this->Form->value('EventType.event_type_id')), array('escape' => false), __('Are you sure you want to delete # %s?', $this->Form->value('EventType.event_type_id'))); ?></li>
