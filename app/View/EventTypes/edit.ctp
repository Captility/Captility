            ...
            <div class="form-group">
                <div style="display: inline-block">
                    <div class="input-group">
                        ...
                        <input class="form-control selected-color" placeholder="Blue" name="data[EventType][color]" maxlength="255" type="text" value="<? echo $this->Form->value('EventType.color');?>" id="EventTypeColor" required="required" readonly>
                    </div>
                </div>
