...
<? $this->Breadcrumbs->addCrumb('<span class="glyphicon glyphicon-th-list"></span>'.__('Lectures'), array('action' => 'index')); ?><?php $this->Breadcrumbs->addCrumb(__('Admin Add Lecture'), '#', array('class' => 'active')); ?>
<!--<div class=" form">-->
...
<div class="row">
    ...
    <div class="col-md-11 column">
        <div class="page-header">
            <h1><?php echo __('Admin Add Lecture'); ?></h1>
        </div>
    </div>
</div>
