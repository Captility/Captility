                ...
                <table cellpadding="0" cellspacing="0" class="table table-striped table-responsive">
                    ...
                    <?php foreach ($lecture['Capture'] as $capture): ?>
                        <tr>
                            ...
                            <td><?php if (!empty($capture['User']['username'])) echo $this->Html->link($capture['User']['username'], array('controller' => 'users', 'action' => 'view', $capture['User']['user_id'])); ?></td>

                            <td><?php if (!empty($capture['Workflow']['name'])) echo $this->Html->link($capture['Workflow']['name'], array('controller' => 'workflows', 'action' => 'view', $capture['Workflow']['workflow_id'])); ?></td>
