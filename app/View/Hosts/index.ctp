...
<? $this->Html->addCrumb(__('Hosts'), '#', array('class' => 'active')); ?>
<!--<div class=" index">-->
				...
				<?php foreach ($hosts as $host): ?>
					<tr>
						...
						<td class="actions">
							...
							<?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>', array('action' => 'delete', $host['Host']['host_id']), array('escape' => false), __('Are you sure you want to delete # %s?', $host['Host']['host_id'])); ?>
						</td>
					</tr>
				<?php endforeach; ?>
				</tbody>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <ul class="nav nav-pills nav-stacked">
                            <li><?php echo $this->Html->link(__('<span class="glyphicon glyphicon-plus"></span>New Host'), array('action' => 'add'), array('escape' => false)); ?></li>
