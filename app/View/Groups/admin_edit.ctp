...
<? $this->Breadcrumbs->addCrumb('<span class="glyphicon el-icon-group"></span>'.__('Groups'),array('action' => 'index')); ?><?php $this->Breadcrumbs->addCrumb(__('Admin Edit Group'), '#', array('class' => 'active')); ?>
<!--<div class=" form">-->
