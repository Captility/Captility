...
<? $this->Breadcrumbs->addCrumb('<span class="glyphicon el-icon-group"></span>'.__('Group'), '#', array('class' => 'active')); ?>
<!--<div class=" view">-->
<div class="row">
...
<div class="col-md-3 column">
    <div class="actions">
		...
		<li><?php echo $this->Form->postLink('<span class="glyphicon glyphicon-trash"></span>' . '<span class="remove-text">' . __('Delete Group') . '</span>', array('action' => 'delete', $group['Group']['group_id']), array('escape' => false), __('Are you sure you want to delete # %s?', $group['Group']['group_id'])); ?> </li>
