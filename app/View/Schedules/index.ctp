            ...
            <?php foreach ($schedules as $schedule): ?>
                <tr onclick="document.location = '<? echo Router::url(array('controller' => $this->name, 'action' => 'view', $schedule['Schedule']['schedule_id'])); ?>';">
                    ...
                    <td class="actions">
                        ...
                        <?php echo $this->Html->link('<span class="glyphicon el-icon-pencil"></span>', array('action' => 'edit', $schedule['Schedule']['schedule_id']), array('escape' => false)); ?>
                        <?php echo $this->Form->postLink('<span class="glyphicon glyphicon-trash"></span>', array('action' => 'delete', $schedule['Schedule']['schedule_id']), array('escape' => false), __('Are you sure you want to delete # %s?', $schedule['Schedule']['schedule_id'])); ?>
                    </td>
                </tr>
            <?php endforeach; ?>
            </tbody>
