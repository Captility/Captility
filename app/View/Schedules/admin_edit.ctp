<? $this->Breadcrumbs->addCrumb(__('Schedules'), array('action' => 'index')); ?><?php $this->Breadcrumbs->addCrumb(__('Admin Edit Schedule'), '#', array('class' => 'active')); ?>
<!--<div class=" form">-->
...
<div class="row">
    ...
    <div class="col-md-11 column">
        <div class="page-header">
            <h1><?php echo __('Admin Edit Schedule'); ?></h1>
        </div>
    </div>
</div>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>'.__('Delete'), array('action' => 'delete', $this->Form->value('Schedule.schedule_id')), array('escape' => false), __('Are you sure you want to delete # %s?', $this->Form->value('Schedule.schedule_id'))); ?></li>
