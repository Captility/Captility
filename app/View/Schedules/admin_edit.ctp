<? $this->Html->addCrumb(__('Schedules'), array('action' => 'index')); ?><?php $this->Html->addCrumb(__('Admin Edit Schedule'), '#', array('class' => 'active')); ?>
<!--<div class=" form">-->
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul class="nav nav-pills nav-stacked">
                    ...
                    <li><?php echo $this->Form->postLink(__('<span class="glyphicon glyphicon-remove"></span>Delete'), array('action' => 'delete', $this->Form->value('Schedule.schedule_id')), array('escape' => false), __('Are you sure you want to delete # %s?', $this->Form->value('Schedule.schedule_id'))); ?></li>
