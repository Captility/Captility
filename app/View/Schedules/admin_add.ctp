<? $this->Breadcrumbs->addCrumb(__('Schedules'), array('action' => 'index')); ?><?php $this->Breadcrumbs->addCrumb(__('Admin Add Schedule'), '#', array('class' => 'active')); ?>
<!--<div class=" form">-->
...
<div class="row">
    ...
    <div class="col-md-11 column">
        <div class="page-header">
            <h1><?php echo __('Admin Add Schedule'); ?></h1>
        </div>
    </div>
</div>
