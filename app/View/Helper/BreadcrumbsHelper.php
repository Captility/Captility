...
class BreadcrumbsHelper extends AppHelper {
    ...
    public function getCrumbs($home = true, $reset = true) {
        ...
        if ($home) {
            ...
            array_unshift($breadcrumbs, array('label' => '<span class="glyphicon cp-icon-logo glyphicon-alone"></span>', 'link' => '/'));
    ...
    protected function _crumbMarkup($breadcrumb) {
        return $this->Html->tag(
            ...
            empty($breadcrumb['link'])
                ...
                : $this->Html->link($breadcrumb['label'], $breadcrumb['link'], array('escape' => false)) . $this->separator
        );
    }
    ...
    protected function _wrapCrumbs($markup) {
        ...
        return $this->Html->tag('ul', $markup, array('class' => 'captility-breadcrumb'));
    }
