...
<? $this->Breadcrumbs->addCrumb(' #' . h($this->request->data['Device']['device_id']) . ' ' . h($this->request->data['Device']['name']), '/devices/view/' . h($this->request->data['Device']['device_id'])); ?>
<? $this->Breadcrumbs->addCrumb('<span class="glyphicon el-icon-pencil"></span>' . __('Edit Device'), '#', array('class' => 'active')); ?>
