        ...
        <table cellpadding="0" cellspacing="0" class="table table-striped">
            ...
            <tr>
                ...
                <td><span class="glyphicon el-icon-hdd"></span>
                    <?php if(!empty($event['Device']['device_id'])) echo $this->Html->link($event['Device']['name'].' ['.$event['Device']['location'].']', array('controller' => 'devices', 'action' => 'view', $event['Device']['device_id'])); ?>
                    &nbsp;
                </td>
            </tr>
            <!--<tr>
