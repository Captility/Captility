...
<div class="col-md-8 column actions-column">
    ...
    if ($params['pageCount'] > 1) {
        ...
        <ul class="pagination pagination-sm">
            <?php
            echo $this->Paginator->prev('← Previous', array('class' => 'prev', 'tag' => 'li', 'escape' => false), '<a onclick="return false;">&larr; Previous</a>', array('class' => 'prev disabled', 'tag' => 'li', 'escape' => true));
            echo $this->Paginator->numbers(array('separator' => '', 'tag' => 'li', 'currentClass' => 'active', 'currentTag' => 'a'));
            echo $this->Paginator->next(__('Next') . ' →', array('class' => 'next', 'tag' => 'li', 'escape' => false), '<a onclick="return false;">Next →</a>', array('class' => 'next disabled', 'escape' => false));
            ?>
        </ul>
    <?php } ?>
