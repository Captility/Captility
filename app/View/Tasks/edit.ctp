...
<? $this->Breadcrumbs->addCrumb(__('Tasks'),array('action' => 'index')); ?><?php $this->Breadcrumbs->addCrumb('<span class="glyphicon el-icon-file-edit"></span>'.__('Edit Task'), '#', array('class' => 'active')); ?>
<!--<div class=" form">-->
...
<div class="col-md-8 column">
    ...
    <?php echo $this->Session->flash(); ?>    <?php echo $this->Session->flash('auth'); ?>
				...
				<div class="form-group">
					<?php echo $this->Form->input('step', array('class' => 'form-control', 'placeholder' => 'Step'));?>
				</div>
				<div class="form-group">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <ul class="nav nav-pills nav-stacked">
                                            ...
                                            <li><?php echo $this->Form->postLink('<span class="glyphicon glyphicon-remove"></span>'.__('Delete'), array('action' => 'delete', $this->Form->value('Task.task_id')), array('escape' => false), __('Are you sure you want to delete # %s?', $this->Form->value('Task.task_id'))); ?></li>
