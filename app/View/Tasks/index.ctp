<div class="tasks index">
	...
	<tr>
		...
		<td class="actions">
			<?php echo $this->Html->link(__('View'), array('action' => 'view', $task['Task']['task_id'])); ?>
			<?php echo $this->Html->link(__('Edit'), array('action' => 'edit', $task['Task']['task_id'])); ?>
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $task['Task']['task_id']), null, __('Are you sure you want to delete # %s?', $task['Task']['task_id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
