...
function(a){a||(this.paused=!0);this.$element.find(".next, .prev").length&&b.support.transition.end&&(this.$element.trigger(b.support.transition.end),this.cycle(!0));this.interval=clearInterval(this.interval);return this};c.prototype.next=function(){if(!this.sliding)return this.slide("next")};c.prototype.prev=function(){if(!this.sliding)return this.slide("prev")};c.prototype.slide=function(a,d){var e=this.$element.find(".item.active"),c=d||e[a](),k=this.interval,h="next"==a?"left":"right",l="next"==
a?"first":"last",f=this;if(!c.length){if(!this.options.wrap)return;c=this.$element.find(".item")[l]()}this.sliding=!0;k&&this.pause();l=b.Event("slide.bs.carousel",{relatedTarget:c[0],direction:h});if(!c.hasClass("active")){this.$indicators.length&&(this.$indicators.find(".active").removeClass("active"),this.$element.one("slid",function(){var a=b(f.$indicators.children()[f.getActiveIndex()]);a&&a.addClass("active")}));if(b.support.transition&&this.$element.hasClass("slide")){this.$element.trigger(l);
if(l.isDefaultPrevented())return;c.addClass(a);c[0].offsetWidth;e.addClass(h);c.addClass(h);e.one(b.support.transition.end,function(){c.removeClass([a,h].join(" ")).addClass("active");e.removeClass(["active",h].join(" "));f.sliding=!1;setTimeout(function(){f.$element.trigger("slid")},0)}).emulateTransitionEnd(600)}else{this.$element.trigger(l);if(l.isDefaultPrevented())return;e.removeClass("active");c.addClass("active");this.sliding=!1;this.$element.trigger("slid")}k&&this.cycle();return this}};var f=
b.fn.carousel;b.fn.carousel=function(a){return this.each(function(){var d=b(this),e=d.data("bs.carousel"),g=b.extend({},c.DEFAULTS,d.data(),"object"==typeof a&&a),k="string"==typeof a?a:g.slide;e||d.data("bs.carousel",e=new c(this,g));if("number"==typeof a)e.to(a);else if(k)e[k]();else g.interval&&e.pause().cycle()})};b.fn.carousel.Constructor=c;b.fn.carousel.noConflict=function(){b.fn.carousel=f;return this};b(document).on("click.bs.carousel.data-api","[data-slide], [data-slide-to]",function(a){var d=
b(this),e,c=b(d.attr("data-target")||(e=d.attr("href"))&&e.replace(/.*(?=#[^\s]+$)/,""));e=b.extend({},c.data(),d.data());var k=d.attr("data-slide-to");k&&(e.interval=!1);c.carousel(e);(k=d.attr("data-slide-to"))&&c.data("bs.carousel").to(k);a.preventDefault()});b(window).on("load",function(){b('[data-ride="carousel"]').each(function(){var a=b(this);a.carousel(a.data())})})}(jQuery);
...
d.insertAfter(this.$element);var e=this.getPosition(),k=d[0].offsetWidth,h=d[0].offsetHeight;if(c){var f=this.$element.parent(),c=a,m=document.documentElement.scrollTop||document.body.scrollTop,n="body"==this.options.container?window.innerWidth:f.outerWidth(),p="body"==this.options.container?window.innerHeight:f.outerHeight(),f="body"==this.options.container?0:f.offset().left,a="bottom"==a&&e.top+e.height+h-m>p?"top":"top"==a&&0>e.top-m-h?"bottom":"right"==a&&e.right+k>n?"left":"left"==a&&e.left-
k<f?"right":a;d.removeClass(c).addClass(a)}d=this.getCalculatedOffset(a,e,k,h);this.applyPlacement(d,a);this.$element.trigger("shown.bs."+this.type)}};c.prototype.applyPlacement=function(a,b){var e,c=this.tip(),f=c[0].offsetWidth,h=c[0].offsetHeight,l=parseInt(c.css("margin-top"),10),m=parseInt(c.css("margin-left"),10);isNaN(l)&&(l=0);isNaN(m)&&(m=0);a.top+=l;a.left+=m;c.offset(a).addClass("in");l=c[0].offsetWidth;m=c[0].offsetHeight;"top"==b&&m!=h&&(e=!0,a.top=a.top+h-m);/bottom|top/.test(b)?(h=
0,0>a.left&&(h=-2*a.left,a.left=0,c.offset(a),l=c[0].offsetWidth),this.replaceArrow(h-f+l,l,"left")):this.replaceArrow(m-h,m,"top");e&&c.offset(a)};c.prototype.replaceArrow=function(a,b,e){this.arrow().css(e,a?50*(1-a/b)+"%":"")};c.prototype.setContent=function(){var a=this.tip(),b=this.getTitle();a.find(".tooltip-inner")[this.options.html?"html":"text"](b);a.removeClass("fade in top bottom left right")};c.prototype.hide=function(){function a(){"in"!=d.hoverState&&e.detach()}var d=this,e=this.tip(),
...
b=(this.$scrollElement[0].scrollHeight||this.$body[0].scrollHeight)-this.$scrollElement.height(),c=this.offsets,g=this.targets,f=this.activeTarget,h;if(a>=b)return f!=(h=g.last()[0])&&this.activate(h);for(h=c.length;h--;)f!=g[h]&&a>=c[h]&&(!c[h+1]||a<=c[h+1])&&this.activate(g[h])};c.prototype.activate=function(a){this.activeTarget=a;b(this.selector).parents(".active").removeClass("active");a=b(this.selector+'[data-target="'+a+'"],'+this.selector+'[href="'+a+'"]').parents("li").addClass("active");
...
function(a,c,e){function g(){f.removeClass("active").find("> .dropdown-menu > .active").removeClass("active");a.addClass("active");h?(a[0].offsetWidth,a.addClass("in")):a.removeClass("fade");a.parent(".dropdown-menu")&&a.closest("li.dropdown").addClass("active");e&&e()}var f=c.find("> .active"),h=e&&b.support.transition&&f.hasClass("fade");h?f.one(b.support.transition.end,g).emulateTransitionEnd(150):g();f.removeClass("in")};var f=b.fn.tab;b.fn.tab=function(a){return this.each(function(){var d=b(this),
...
b(document).height(),d=this.$window.scrollTop(),e=this.$element.offset(),g=this.options.offset,f=g.top,h=g.bottom;"object"!=typeof g&&(h=f=g);"function"==typeof f&&(f=g.top());"function"==typeof h&&(h=g.bottom());a=null!=this.unpin&&d+this.unpin<=e.top?!1:null!=h&&e.top+this.$element.height()>=a-h?"bottom":null!=f&&d<=f?"top":!1;this.affixed!==a&&(this.unpin&&this.$element.css("top",""),this.affixed=a,this.unpin="bottom"==a?e.top-d:null,this.$element.removeClass(c.RESET).addClass("affix"+(a?"-"+a:
"")),"bottom"==a&&this.$element.offset({top:document.body.offsetHeight-h-this.$element.height()}))}};var f=b.fn.affix;b.fn.affix=function(a){return this.each(function(){var d=b(this),e=d.data("bs.affix"),g="object"==typeof a&&a;e||d.data("bs.affix",e=new c(this,g));if("string"==typeof a)e[a]()})};b.fn.affix.Constructor=c;b.fn.affix.noConflict=function(){b.fn.affix=f;return this};b(window).on("load",function(){b('[data-spy="affix"]').each(function(){var a=b(this),c=a.data();c.offset=c.offset||{};c.offsetBottom&&
(c.offset.bottom=c.offsetBottom);c.offsetTop&&(c.offset.top=c.offsetTop);a.affix(c)})})}(jQuery);
(function(b){var c=["#000000 #424242 #636363 #9C9C94 #CEC6CE #EFEFEF #F7F7F7 #FFFFFF".split(" "),"#FF0000 #FF9C00 #FFFF00 #00FF00 #00FFFF #0000FF #9C00FF #FF00FF".split(" "),"#F7C6CE #FFE7CE #FFEFC6 #D6EFD6 #CEDEE7 #CEE7F7 #D6D6E7 #E7D6DE".split(" "),"#E79C9C #FFC69C #FFE79C #B5D6A5 #A5C6CE #9CC6EF #B5A5D6 #D6A5BD".split(" "),"#E76363 #F7AD6B #FFD663 #94BD7B #73A5AD #6BADDE #8C7BC6 #C67BA5".split(" "),"#CE0000 #E79439 #EFC631 #6BA54A #4A7B8C #3984C6 #634AA5 #A54A7B".split(" "),"#9C0000 #B56308 #BD9400 #397B21 #104A5A #085294 #311873 #731842".split(" "),
"#630000 #7B3900 #846300 #295218 #083139 #003163 #21104A #4A1031".split(" ")],f=function(a,c){a.addClass("bootstrap-colorpalette");var d=[];b.each(c,function(a,c){d.push("<div>");b.each(c,function(a,b){var c=['<button type="button" class="btn-color" style="background-color:',b,'" data-value="',eventColorNames[a],'" title="',b,'"></button>'].join("");d.push(c)});d.push("</div>")});a.html(d.join(""))},a=function(a){a.element.on("click",function(c){c=b(c.target).closest(".btn-color");c[0]&&(c=c.attr("data-value"),
a.value=c,a.element.trigger({type:"selectColor",color:c,element:a.element}))})},d=function(b,d){this.element=b;f(b,d&&d.colors||c);a(this)};b.fn.extend({colorPalette:function(a){this.each(function(){var c=b(this);c.data("colorpalette")||c.data("colorpalette",new d(c,a))});return this}})})(jQuery);
