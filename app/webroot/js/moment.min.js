...
function aa(a){var b;if(a._a&&-2===a._pf.overflow){b=0>a._a[w]||11<a._a[w]?w:1>a._a[t]||a._a[t]>(new Date(Date.UTC(a._a[r],a._a[w]+1,0))).getUTCDate()?t:0>a._a[q]||23<a._a[q]?q:0>a._a[x]||59<a._a[x]?x:0>a._a[B]||59<a._a[B]?B:0>a._a[C]||999<a._a[C]?C:-1;if(a._pf._overflowDayOfYear&&(b<r||b>t))b=t;a._pf.overflow=b}}function da(a){null==a._isValid&&(a._isValid=!isNaN(a._d.getTime())&&0>a._pf.overflow&&!a._pf.empty&&!a._pf.invalidMonth&&!a._pf.nullInput&&!a._pf.invalidFormat&&!a._pf.userInvalidated,a._strict&&
...
c).join("-")))return d;if(f&&f.length>=c&&ca(g,f,!0)>=c-1)break;c--}b++}return e.fn._lang}function xa(a){var b=a.match(fa),c,d;c=0;for(d=b.length;c<d;c++)b[c]=u[b[c]]?u[b[c]]:b[c].match(/\[[\s\S]/)?b[c].replace(/^\[|\]$/g,""):b[c].replace(/\\/g,"");return function(f){var e="";for(c=0;c<d;c++)e+=b[c]instanceof Function?b[c].call(f,a):b[c];return e}}function N(a,b){if(!a.isValid())return a.lang().invalidDate();b=ga(b,a.lang());O[b]||(O[b]=xa(b));return O[b](a)}function ga(a,b){function c(a){return b.longDateFormat(a)||
a}var d=5;for(D.lastIndex=0;0<=d&&D.test(a);)a=a.replace(D,c),D.lastIndex=0,d-=1;return a}function ya(a,b){var c=b._strict;switch(a){case "DDDD":return ha;case "YYYY":case "GGGG":case "gggg":return c?za:Aa;case "Y":case "G":case "g":return Ba;case "YYYYYY":case "YYYYY":case "GGGGG":case "ggggg":return c?Ca:Da;case "S":if(c)return Ea;case "SS":if(c)return ia;case "SSS":if(c)return ha;case "DDD":return Fa;case "MMM":case "MMMM":case "dd":case "ddd":case "dddd":return Ga;case "a":case "A":return s(b._l)._meridiemParse;
case "X":return Ha;case "Z":case "ZZ":return P;case "T":return Ia;case "SSSS":return Ja;case "MM":case "DD":case "YY":case "GG":case "gg":case "HH":case "hh":case "mm":case "ss":case "ww":case "WW":return c?ia:ja;case "M":case "D":case "d":case "H":case "h":case "m":case "s":case "w":case "W":case "e":case "E":return ja;default:var c=RegExp,d;d=Ka(a.replace("\\","")).replace(/[-\/\\^$*+?.()|[\]{}]/g,"\\$&");return new c(d)}}function ka(a){a=(a||"").match(P)||[];a=((a[a.length-1]||[])+"").match(La)||
["-",0,0];var b=+(60*a[1])+k(a[2]);return"+"===a[0]?-b:b}function Q(a){var b,c=[],d,f,g,h,l;if(!a._d){d=Ma(a);a._w&&(null==a._a[t]&&null==a._a[w])&&(b=function(b){var c=parseInt(b,10);return b?3>b.length?68<c?1900+c:2E3+c:c:null==a._a[r]?e().weekYear():a._a[r]},f=a._w,null!=f.GG||null!=f.W||null!=f.E?b=la(b(f.GG),f.W||1,f.E,4,1):(g=s(a._l),h=null!=f.d?ma(f.d,g):null!=f.e?parseInt(f.e,10)+g._week.dow:0,l=parseInt(f.w,10)||1,null!=f.d&&h<g._week.dow&&l++,b=la(b(f.gg),l,h,g._week.doy,g._week.dow)),a._a[r]=
b.year,a._dayOfYear=b.dayOfYear);if(a._dayOfYear){b=null==a._a[r]?d[r]:a._a[r];if(a._dayOfYear>(K(b)?366:365))a._pf._overflowDayOfYear=!0;b=R(b,0,a._dayOfYear);a._a[w]=b.getUTCMonth();a._a[t]=b.getUTCDate()}for(b=0;3>b&&null==a._a[b];++b)a._a[b]=c[b]=d[b];for(;7>b;b++)a._a[b]=c[b]=null==a._a[b]?2===b?1:0:a._a[b];c[q]+=k((a._tzm||0)/60);c[x]+=k((a._tzm||0)%60);a._d=(a._useUTC?R:Na).apply(null,c)}}function Ma(a){var b=new Date;return a._useUTC?[b.getUTCFullYear(),b.getUTCMonth(),b.getUTCDate()]:[b.getFullYear(),
b.getMonth(),b.getDate()]}function S(a){a._a=[];a._pf.empty=!0;var b=s(a._l),c=""+a._i,d,f,e,h,l=c.length,m=0;f=ga(a._f,b).match(fa)||[];for(b=0;b<f.length;b++){e=f[b];if(d=(c.match(ya(e,a))||[])[0])h=c.substr(0,c.indexOf(d)),0<h.length&&a._pf.unusedInput.push(h),c=c.slice(c.indexOf(d)+d.length),m+=d.length;if(u[e]){d?a._pf.empty=!1:a._pf.unusedTokens.push(e);h=a;var p=void 0,n=h._a;switch(e){case "M":case "MM":null!=d&&(n[w]=k(d)-1);break;case "MMM":case "MMMM":p=s(h._l).monthsParse(d);null!=p?n[w]=
...
parseFloat(d));break;case "Z":case "ZZ":h._useUTC=!0;h._tzm=ka(d);break;case "w":case "ww":case "W":case "WW":case "d":case "dd":case "ddd":case "dddd":case "e":case "E":e=e.substr(0,1);case "gg":case "gggg":case "GG":case "GGGG":case "GGGGG":e=e.substr(0,2),d&&(h._w=h._w||{},h._w[e]=d)}}else a._strict&&!d&&a._pf.unusedTokens.push(e)}a._pf.charsLeftOver=l-m;0<c.length&&a._pf.unusedInput.push(c);a._isPm&&12>a._a[q]&&(a._a[q]+=12);!1===a._isPm&&12===a._a[q]&&(a._a[q]=0);Q(a);aa(a)}function Ka(a){return a.replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g,
function(a,c,d,f,e){return c||d||f||e})}function Na(a,b,c,d,f,e,h){b=new Date(a,b,c,d,f,e,h);1970>a&&b.setFullYear(a);return b}function R(a){var b=new Date(Date.UTC.apply(null,arguments));1970>a&&b.setUTCFullYear(a);return b}function ma(a,b){if("string"===typeof a)if(isNaN(a)){if(a=b.weekdaysParse(a),"number"!==typeof a)return null}else a=parseInt(a,10);return a}function Oa(a,b,c,d,f){return f.relativeTime(b||1,!!c,a,d)}function E(a,b,c){b=c-b;c-=a.day();c>b&&(c-=7);c<b-7&&(c+=7);a=e(a).add("d",c);
return{week:Math.ceil(a.dayOfYear()/7),year:a.year()}}function la(a,b,c,d,f){var e=R(a,0,1).getUTCDay();b=7*(b-1)+((null!=c?c:f)-f)+(f-e+(e>d?7:0)-(e<f?7:0))+1;return{year:0<b?a:a-1,dayOfYear:0<b?b:(K(a-1)?366:365)+b}}function na(a){var b=a._i,c=a._f;if(null===b)return e.invalid({nullInput:!0});"string"===typeof b&&(a._i=b=s().preparse(b));if(e.isMoment(b)){a=b;var d={},f;for(f in a)a.hasOwnProperty(f)&&Pa.hasOwnProperty(f)&&(d[f]=a[f]);a=d;a._d=new Date(+b._d)}else if(c)if(J(c)){var b=a,g,h;if(0===
b._f.length)b._pf.invalidFormat=!0,b._d=new Date(NaN);else{for(f=0;f<b._f.length;f++)if(c=0,d=p({},b),d._pf=F(),d._f=b._f[f],S(d),da(d)&&(c+=d._pf.charsLeftOver,c+=10*d._pf.unusedTokens.length,d._pf.score=c,null==h||c<h))h=c,g=d;p(b,g||d)}}else S(a);else if(d=a,g=d._i,h=Qa.exec(g),g===A)d._d=new Date;else if(h)d._d=new Date(+h[1]);else if("string"===typeof g)if(b=d._i,f=Ra.exec(b)){d._pf.iso=!0;g=0;for(h=T.length;g<h;g++)if(T[g][1].exec(b)){d._f=T[g][0]+(f[6]||" ");break}g=0;for(h=U.length;g<h;g++)if(U[g][1].exec(b)){d._f+=
U[g][0];break}b.match(P)&&(d._f+="Z");S(d)}else d._d=new Date(b);else J(g)?(d._a=g.slice(0),Q(d)):"[object Date]"===Object.prototype.toString.call(g)||g instanceof Date?d._d=new Date(+g):"object"===typeof g?d._d||(g=ba(d._i),d._a=[g.year,g.month,g.day,g.hour,g.minute,g.second,g.millisecond],Q(d)):d._d=new Date(g);return new G(a)}function oa(a,b){e.fn[a]=e.fn[a+"s"]=function(a){var d=this._isUTC?"UTC":"";return null!=a?(this._d["set"+d+b](a),e.updateOffset(this),this):this._d["get"+d+b]()}}function Sa(a){e.duration.fn[a]=
function(){return this._data[a]}}function pa(a,b){e.duration.fn["as"+a]=function(){return+this/b}}function V(a){var b=!1,c=e;"undefined"===typeof ender&&(a?(W.moment=function(){!b&&(console&&console.warn)&&(b=!0,console.warn("Accessing Moment through the global scope is deprecated, and will be removed in an upcoming release."));return c.apply(null,arguments)},p(W.moment,c)):W.moment=e)}for(var e,W=this,z=Math.round,l,r=0,w=1,t=2,q=3,x=4,B=5,C=6,y={},Pa={_isAMomentObject:null,_i:null,_f:null,_l:null,
_strict:null,_isUTC:null,_offset:null,_pf:null,_lang:null},ea="undefined"!==typeof module&&module.exports&&"undefined"!==typeof require,Qa=/^\/?Date\((\-?\d+)/i,Ta=/(\-)?(?:(\d*)\.)?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?)?/,Ua=/^(-)?P(?:(?:([0-9,.]*)Y)?(?:([0-9,.]*)M)?(?:([0-9,.]*)D)?(?:T(?:([0-9,.]*)H)?(?:([0-9,.]*)M)?(?:([0-9,.]*)S)?)?|([0-9,.]*)W)$/,fa=/(\[[^\[]*\])|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|YYYYYY|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|S{1,4}|X|zz?|ZZ?|.)/g,
D=/(\[[^\[]*\])|(\\)?(LT|LL?L?L?|l{1,4})/g,ja=/\d\d?/,Fa=/\d{1,3}/,Aa=/\d{1,4}/,Da=/[+\-]?\d{1,6}/,Ja=/\d+/,Ga=/[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,P=/Z|[\+\-]\d\d:?\d\d/gi,Ia=/T/i,Ha=/[\+\-]?\d+(\.\d{1,3})?/,Ea=/\d/,ia=/\d\d/,ha=/\d{3}/,za=/\d{4}/,Ca=/[+-]?\d{6}/,Ba=/[+-]?\d+/,Ra=/^\s*(?:[+-]\d{6}|\d{4})-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?$/,T=
[["YYYYYY-MM-DD",/[+-]\d{6}-\d{2}-\d{2}/],["YYYY-MM-DD",/\d{4}-\d{2}-\d{2}/],["GGGG-[W]WW-E",/\d{4}-W\d{2}-\d/],["GGGG-[W]WW",/\d{4}-W\d{2}/],["YYYY-DDD",/\d{4}-\d{3}/]],U=[["HH:mm:ss.SSSS",/(T| )\d\d:\d\d:\d\d\.\d{1,3}/],["HH:mm:ss",/(T| )\d\d:\d\d:\d\d/],["HH:mm",/(T| )\d\d:\d\d/],["HH",/(T| )\d\d/]],La=/([\+\-]|\d\d)/gi,X=["Date","Hours","Minutes","Seconds","Milliseconds"],Y={Milliseconds:1,Seconds:1E3,Minutes:6E4,Hours:36E5,Days:864E5,Months:2592E6,Years:31536E6},ua={ms:"millisecond",s:"second",
...
M:a._months};else if("number"===typeof a)c={},b?c[b]=a:c.milliseconds=a;else if(d=Ta.exec(a))f="-"===d[1]?-1:1,c={y:0,d:k(d[t])*f,h:k(d[q])*f,m:k(d[x])*f,s:k(d[B])*f,ms:k(d[C])*f};else if(d=Ua.exec(a))f="-"===d[1]?-1:1,c=function(a){a=a&&parseFloat(a.replace(",","."));return(isNaN(a)?0:a)*f},c={y:c(d[2]),M:c(d[3]),d:c(d[4]),h:c(d[5]),m:c(d[6]),s:c(d[7]),w:c(d[8])};d=new H(c);e.isDuration(a)&&a.hasOwnProperty("_lang")&&(d._lang=a._lang);return d};e.version="2.5.1";e.defaultFormat="YYYY-MM-DDTHH:mm:ssZ";
...
a)},calendar:function(){var a=M(e(),this).startOf("day"),a=this.diff(a,"days",!0);return this.format(this.lang().calendar(-6>a?"sameElse":-1>a?"lastWeek":0>a?"lastDay":1>a?"sameDay":2>a?"nextDay":7>a?"nextWeek":"sameElse",this))},isLeapYear:function(){return K(this.year())},isDST:function(){return this.zone()<this.clone().month(0).zone()||this.zone()<this.clone().month(5).zone()},day:function(a){var b=this._isUTC?this._d.getUTCDay():this._d.getDay();return null!=a?(a=ma(a,this.lang()),this.add({d:a-
...
d.milliseconds=a%1E3;a=v(a/1E3);d.seconds=a%60;a=v(a/60);d.minutes=a%60;a=v(a/60);d.hours=a%24;b+=v(a/24);d.days=b%30;c+=v(b/30);d.months=c%12;b=v(c/12);d.years=b},weeks:function(){return v(this.days()/7)},valueOf:function(){return this._milliseconds+864E5*this._days+2592E6*(this._months%12)+31536E6*k(this._months/12)},humanize:function(a){var b=+this,c;c=!a;var d=this.lang(),e=z(Math.abs(b)/1E3),g=z(e/60),h=z(g/60),k=z(h/24),l=z(k/365),e=45>e&&["s",e]||1===g&&["m"]||45>g&&["mm",g]||1===h&&["h"]||
22>h&&["hh",h]||1===k&&["d"]||25>=k&&["dd",k]||45>=k&&["M"]||345>k&&["MM",z(k/30)]||1===l&&["y"]||["yy",l];e[2]=c;e[3]=0<b;e[4]=d;c=Oa.apply({},e);a&&(c=this.lang().pastFuture(b,c));return this.lang().postformat(c)},add:function(a,b){var c=e.duration(a,b);this._milliseconds+=c._milliseconds;this._days+=c._days;this._months+=c._months;this._bubble();return this},subtract:function(a,b){var c=e.duration(a,b);this._milliseconds-=c._milliseconds;this._days-=c._days;this._months-=c._months;this._bubble();
return this},get:function(a){a=n(a);return this[a.toLowerCase()+"s"]()},as:function(a){a=n(a);return this["as"+a.charAt(0).toUpperCase()+a.slice(1)+"s"]()},lang:e.fn.lang,toIsoString:function(){var a=Math.abs(this.years()),b=Math.abs(this.months()),c=Math.abs(this.days()),d=Math.abs(this.hours()),e=Math.abs(this.minutes()),g=Math.abs(this.seconds()+this.milliseconds()/1E3);return!this.asSeconds()?"P0D":(0>this.asSeconds()?"-":"")+"P"+(a?a+"Y":"")+(b?b+"M":"")+(c?c+"D":"")+(d||e||g?"T":"")+(d?d+"H":
"")+(e?e+"M":"")+(g?g+"S":"")}});for(l in Y)Y.hasOwnProperty(l)&&(pa(l,Y[l]),Sa(l.toLowerCase()));pa("Weeks",6048E5);e.duration.fn.asMonths=function(){return(+this-31536E6*this.years())/2592E6+12*this.years()};e.lang("en",{ordinal:function(a){var b=a%10,b=1===k(a%100/10)?"th":1===b?"st":2===b?"nd":3===b?"rd":"th";return a+b}});e.lang("en");(function(a){a(e)})(function(a){function b(a,b,e,g){a={m:["eine Minute","einer Minute"],h:["eine Stunde","einer Stunde"],d:["ein Tag","einem Tag"],dd:[a+" Tage",
a+" Tagen"],M:["ein Monat","einem Monat"],MM:[a+" Monate",a+" Monaten"],y:["ein Jahr","einem Jahr"],yy:[a+" Jahre",a+" Jahren"]};return b?a[e][0]:a[e][1]}return a.lang("de",{months:"Januar Februar M\u00e4rz April Mai Juni Juli August September Oktober November Dezember".split(" "),monthsShort:"Jan. Febr. Mrz. Apr. Mai Jun. Jul. Aug. Sept. Okt. Nov. Dez.".split(" "),weekdays:"Sonntag Montag Dienstag Mittwoch Donnerstag Freitag Samstag".split(" "),weekdaysShort:"So. Mo. Di. Mi. Do. Fr. Sa.".split(" "),
weekdaysMin:"So Mo Di Mi Do Fr Sa".split(" "),longDateFormat:{LT:"H:mm [Uhr]",L:"DD.MM.YYYY",LL:"D. MMMM YYYY",LLL:"D. MMMM YYYY LT",LLLL:"dddd, D. MMMM YYYY LT"},calendar:{sameDay:"[Heute um] LT",sameElse:"L",nextDay:"[Morgen um] LT",nextWeek:"dddd [um] LT",lastDay:"[Gestern um] LT",lastWeek:"[letzten] dddd [um] LT"},relativeTime:{future:"in %s",past:"vor %s",s:"ein paar Sekunden",m:b,mm:"%d Minuten",h:b,hh:"%d Stunden",d:b,dd:b,M:b,MM:b,y:b,yy:b},ordinal:"%d.",week:{dow:1,doy:4}})});ea?(module.exports=
e,V(!0)):"function"===typeof define&&define.amd?define("moment",function(a,b,c){c.config&&(c.config()&&!0!==c.config().noGlobal)&&V(c.config().noGlobal===A);return e}):V()}).call(this);
