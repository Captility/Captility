...
new Date(b.date)):window.location.href="/captility/calendars/?date="+b.date})});
...
-1<window.location.href.indexOf("full_calendar"))$mediaQueryHeader.left="agendaDay,agendaWeek,month",$mediaQueryHeader.center="title",$mediaQueryHeader.right="prev,today,next",$mediaQueryView="month",$hiddenDays=[0];$(document).width()<$mobileMaxWidth&&($mediaQueryView="agendaDay");$(window).bind("resize",function(){$(document).width()<$mobileMaxWidth?$("#calendar").fullCalendar("changeView","agendaDay"):$("#calendar").fullCalendar("changeView","agendaWeek")});var d={url:"/captility/events/feed",
type:"GET",cache:!1},a={url:"/captility/events/feedMy",type:"GET",cache:!1};$('a[data-toggle="tab"]').on("shown.bs.tab",function(a){$("#calendar").fullCalendar("render");$("#calendar").fullCalendar("render")});$("#GeneralViewFc").click(function(){$(this).parent().hasClass("active")||$("#calendar").fullCalendar("removeEventSource",a).fullCalendar("removeEventSource",d).fullCalendar("addEventSource",d)});$("#MyWeekViewFc").click(function(){$(this).parent().hasClass("active")||$("#calendar").fullCalendar("removeEventSource",
d).fullCalendar("removeEventSource",a).fullCalendar("addEventSource",a)});$("#calendar").fullCalendar({header:$mediaQueryHeader,defaultView:$mediaQueryView,weekMode:"variable",allDaySlot:!1,weekends:!0,firstDay:1,hiddenDays:$hiddenDays,aspectRatio:1.26,firstHour:8,minTime:6,maxTime:22,axisFormat:"HH:mm",formatDate:"dd.MM.yyyy HH:mm:ss",titleFormat:{month:"MMMM yyyy",week:"dd.[ MMM.][yy]{ '&#8211;' dd. MMMM yyyy}",day:"dddd, dd.MM.yyyy"},columnFormat:{month:"ddd",week:"ddd - d.M.",day:"dddd d.M."},
timeFormat:"HH:mm{ \u2013 HH:mm}' Uhr'",monthNames:"Januar Februar M\u00e4rz April Mai Juni Juli August September Oktober November Dezember".split(" "),monthNamesShort:"Jan Feb Mrz Apr Mai Jun Jul Aug Sept Okt Nov Dez".split(" "),dayNames:"Sonntag Montag Dienstag Mittwoch Donnerstag Freitag Samstag".split(" "),dayNamesShort:"So Mo Di Mi Do Fr Sa".split(" "),allDayText:"Ganzt\u00e4gig",buttonText:{today:"Heute",month:"Monat",week:"Woche",day:"Tag"},eventSources:[d],editable:!0,selectable:!0,viewRender:function(a,
b){$("#SideCalendar").datepicker("update",new Date(a.start))},eventClick:function(a,n,e){a.place="H12";e='<ul class="list-group"><li><span class="glyphicon glyphicon-calendar"></span>'+a.datec+' <li><span class="glyphicon glyphicon-time gl-ml"></span>'+a.time+" "+(a.place&&'  <span class="glyphicon glyphicon-map-marker gl-ml"></span>'+a.place+"</li><br/>"||"")+(a.niceEnd&&"<p><b>End:</b> "+a.end+"</p>"||"")+'<li><span class="glyphicon glyphicon-th-list"></span><a href="lectures/view/'+a.Lecture.lecture_id+
...
a.capture_id+'">Anzeigen';console.log(a);b.set({"content.text":e,"content.title":'<span class="glyphicon glyphicon-film"></span>'+a.title,"style.classes":"qtip-bootstrap qtip-"+a.className}).reposition(n).show(n)},eventResizeStart:function(){b.hide()},eventDragStart:function(){b.hide()},viewDisplay:function(){b.hide()},eventDrop:function(a){var b=new Date(a.start),e=b.getFullYear(),d=b.getDate(),f=b.getMonth()+1,g=b.getHours(),b=b.getMinutes(),c=new Date(a.end),h=c.getFullYear(),k=c.getDate(),l=c.getMonth()+
1,m=c.getHours(),c=c.getMinutes();$.post("events/update?id="+a.id+"&start="+e+"-"+f+"-"+d+" "+g+":"+b+":00&end="+h+"-"+l+"-"+k+" "+m+":"+c+":00&allday="+(!0==a.allDay?1:0),function(a){})},eventResize:function(a){var b=new Date(a.start),e=b.getFullYear(),d=b.getDate(),f=b.getMonth()+1,g=b.getHours(),b=b.getMinutes(),c=new Date(a.end),h=c.getFullYear(),k=c.getDate(),l=c.getMonth()+1,m=c.getHours(),c=c.getMinutes();$.post("events/update?id="+a.id+"&start="+e+"-"+f+"-"+d+" "+g+":"+b+":00&end="+h+"-"+
l+"-"+k+" "+m+":"+c+":00",function(a){})}});if($("#calendar").length){var e=getParameterByName("date",window.location.href);e&&$("#calendar").fullCalendar("gotoDate",new Date(e))}});var eventColorValues={colors:["#202020 #3a87ad #f70 #009406 #FFEB00 #FD3E20 #5F43A8 #009B9B #579B00 #FF38D7 #FDFDFD".split(" ")]},eventColorNames="Black Blue Orange Green Yellow Red Purple Indigo Mint Pink White".split(" ");
...
d=$(".btn-scrollTop").first();b.on("click","button.btn-scrollTop",function(){$("html, body").animate({scrollTop:$("body").offset().top},600)});d.offset().top<$(window).height()&&d.hide()});
