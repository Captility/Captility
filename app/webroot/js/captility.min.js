...
$("#calendar").fullCalendar("changeView","agendaWeek")});var e={url:$appRoot+"events/feed",type:"GET",cache:!1},f={url:$appRoot+"events/feed/my",type:"GET",cache:!1};$('a[data-toggle="tab"]').on("shown.bs.tab",function(b){$("#calendar").fullCalendar("render");$("#calendar").fullCalendar("render")});$("#GeneralViewFc").click(function(){$(this).parent().hasClass("active")||$("#calendar").fullCalendar("removeEventSource",f).fullCalendar("removeEventSource",e).fullCalendar("addEventSource",e)});$("#MyWeekViewFc").click(function(){$(this).parent().hasClass("active")||
