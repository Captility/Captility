$mobileMaxWidth=992;function getParameterByName(a,c){a=a.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var f=RegExp("[\\?&]"+a+"=([^&#]*)").exec(c);return null==f?"":decodeURIComponent(f[1].replace(/\+/g," "))}$(function(){var a=window.location.hash;a&&$('ul.nav a[href="'+a+'"]').first().tab("show");$(".nav-tabs a").click(function(a){a=$("body").scrollTop();window.location.hash=this.hash;$("html,body").scrollTop(a)})});
(function(a){a.fn.datepicker.dates.de={days:"Sonntag Montag Dienstag Mittwoch Donnerstag Freitag Samstag Sonntag".split(" "),daysMin:"So Mo Di Mi Do Fr Sa So".split(" "),daysShort:"So Mo Di Mi Do Fr Sa So".split(" "),months:"Januar Februar M\u00e4rz April Mai Juni Juli August September Oktober November Dezember".split(" "),monthsShort:"Jan Feb M\u00e4r Apr Mai Jun Jul Aug Sep Okt Nov Dez".split(" "),today:"Heute",weekStart:1,format:"D, dd.mm.yyyy"}})(jQuery);
$(document).ready(function(){$("#SideCalendar").datepicker({format:"dd/mm/yyyy",weekStart:1,todayBtn:!0,language:"de",orientation:"top center",daysOfWeekDisabled:"0,6",calendarWeeks:!0,todayHighlight:!0,selectWeek:!0,autoclose:!0,todayBtn:!0},function(){});$(".pickDate").datepicker({weekStart:1,language:"de",todayHighlight:!0,autoclose:!0,orientation:"top center",todayBtn:"linked"},function(){});$("#SideCalendar").datepicker().on("changeDate",function(a){$("#calendar").length?$("#calendar").fullCalendar("gotoDate",
new Date(a.date)):window.location.href="/captility/calendars/?date="+a.date})});
$(document).ready(function(){var a=$("<div/>").qtip({id:"calendar",prerender:!0,content:{text:" ",title:{button:!0}},position:{my:"top center",at:" center",target:"mouse",viewport:$("#calendar"),adjust:{mouse:!1,scroll:!1}},show:!1,hide:{event:"click",effect:function(){$(this).animate({opacity:0},{duration:300})}},style:"qtip-bootstrap"}).qtip("api");$mediaQueryHeader={left:"title",center:"",right:"prev,today,next"};$mediaQueryView="agendaWeek";$hiddenDays=[0,6];if(-1<window.location.href.indexOf("calendar")||
-1<window.location.href.indexOf("full_calendar"))$mediaQueryHeader.left="agendaDay,agendaWeek,month",$mediaQueryHeader.center="title",$mediaQueryHeader.right="prev,today,next",$mediaQueryView="month",$hiddenDays=[0];$(document).width()<$mobileMaxWidth&&($mediaQueryView="agendaDay");$(window).bind("resize",function(){$(document).width()<$mobileMaxWidth?$("#calendar").fullCalendar("changeView","agendaDay"):$("#calendar").fullCalendar("changeView","agendaWeek")});var c={url:"events/feed",type:"GET",
cache:!1},f={url:"events/feedMy",type:"GET",cache:!1};$('a[data-toggle="tab"]').on("shown.bs.tab",function(a){$("#calendar").fullCalendar("render");$("#calendar").fullCalendar("render")});$("#GeneralViewFc").click(function(){$(this).parent().hasClass("active")||$("#calendar").fullCalendar("removeEventSource",f).fullCalendar("removeEventSource",c).fullCalendar("addEventSource",c)});$("#MyWeekViewFc").click(function(){$(this).parent().hasClass("active")||$("#calendar").fullCalendar("removeEventSource",
c).fullCalendar("removeEventSource",f).fullCalendar("addEventSource",f)});$("#calendar").fullCalendar({header:$mediaQueryHeader,defaultView:$mediaQueryView,weekMode:"variable",allDaySlot:!1,weekends:!0,firstDay:1,hiddenDays:$hiddenDays,aspectRatio:1.26,firstHour:8,minTime:6,maxTime:22,axisFormat:"HH:mm",formatDate:"dd.MM.yyyy HH:mm:ss",titleFormat:{month:"MMMM yyyy",week:"dd.[ MMM.][yy]{ '&#8211;' dd. MMMM yyyy}",day:"dddd, dd.MM.yyyy"},columnFormat:{month:"ddd",week:"ddd - d.M.",day:"dddd d.M."},
timeFormat:"HH:mm{ \u2013 HH:mm}' Uhr'",monthNames:"Januar Februar M\u00e4rz April Mai Juni Juli August September Oktober November Dezember".split(" "),monthNamesShort:"Jan Feb Mrz Apr Mai Jun Jul Aug Sept Okt Nov Dez".split(" "),dayNames:"Sonntag Montag Dienstag Mittwoch Donnerstag Freitag Samstag".split(" "),dayNamesShort:"So Mo Di Mi Do Fr Sa".split(" "),allDayText:"Ganzt\u00e4gig",buttonText:{today:"Heute",month:"Monat",week:"Woche",day:"Tag"},eventSources:[c],editable:!0,selectable:!0,viewRender:function(a,
d){$("#SideCalendar").datepicker("update",new Date(a.start))},eventClick:function(b,d,c){b.place="H12";c='<ul class="list-group"><li><span class="glyphicon glyphicon-calendar"></span>'+b.datec+' <li><span class="glyphicon glyphicon-time gl-ml"></span>'+b.time+" "+(b.place&&'  <span class="glyphicon glyphicon-map-marker gl-ml"></span>'+b.place+"</li><br/>"||"")+(b.niceEnd&&"<p><b>End:</b> "+b.end+"</p>"||"")+'<li><span class="glyphicon glyphicon-th-list"></span><a href="lectures/view/'+b.Lecture.lecture_id+
'">'+b.Lecture.number+" "+b.Lecture.name+"</a>"+(b.Lecture.link&&'<a href="'+b.Lecture.link+'"> <span class="glyphicon glyphicon-link gl-ms"></span></a>')+'</li><br/><li><span class="glyphicon cp-icon-lecturer"></span><a href="hosts/view/'+b.Host.host_id+'">'+b.Host.name+"</a>"+(b.Host.email&&'<a href="mailto:'+b.Host.email+'"> <span class="glyphicon glyphicon-envelope gl-ms"></span></a>')+(b.Host.contact_email&&'<a href="mailto:'+b.Host.contact_email+'"><span class="glyphicon glyphicon-envelope gl-ms"></span></a>')+
...
b.capture_id+'">Anzeigen';console.log(b);a.set({"content.text":c,"content.title":'<span class="glyphicon glyphicon-film"></span>'+b.title,"style.classes":"qtip-bootstrap qtip-"+b.className}).reposition(d).show(d)},eventResizeStart:function(){a.hide()},eventDragStart:function(){a.hide()},viewDisplay:function(){a.hide()},eventDrop:function(a){var d=new Date(a.start),c=d.getFullYear(),f=d.getDate(),g=d.getMonth()+1,h=d.getHours(),d=d.getMinutes(),e=new Date(a.end),k=e.getFullYear(),l=e.getDate(),m=e.getMonth()+
1,n=e.getHours(),e=e.getMinutes();$.post("events/update?id="+a.id+"&start="+c+"-"+g+"-"+f+" "+h+":"+d+":00&end="+k+"-"+m+"-"+l+" "+n+":"+e+":00&allday="+(!0==a.allDay?1:0),function(a){})},eventResize:function(a){var d=new Date(a.start),c=d.getFullYear(),f=d.getDate(),g=d.getMonth()+1,h=d.getHours(),d=d.getMinutes(),e=new Date(a.end),k=e.getFullYear(),l=e.getDate(),m=e.getMonth()+1,n=e.getHours(),e=e.getMinutes();$.post("events/update?id="+a.id+"&start="+c+"-"+g+"-"+f+" "+h+":"+d+":00&end="+k+"-"+
m+"-"+l+" "+n+":"+e+":00",function(a){})}});if($("#calendar").length){var p=getParameterByName("date",window.location.href);p&&$("#calendar").fullCalendar("gotoDate",new Date(p))}});var eventColorValues={colors:["#202020 #3a87ad #f70 #009406 #FFEB00 #FD3E20 #5F43A8 #009B9B #579B00 #FF38D7 #FDFDFD".split(" ")]},eventColorNames="Black Blue Orange Green Yellow Red Purple Indigo Mint Pink White".split(" ");
$(document).ready(function(){$(".colorpalette").colorPalette(eventColorValues).on("selectColor",function(a){$(".selected-color").val(a.color)});$(document).keydown(function(a){if($(event.target).is("input, textarea, select"))return!0;if(37==a.keyCode||65==a.keyCode)return $(".fc-button-prev").click(),!0;if(39==a.keyCode||68==a.keyCode)return $(".fc-button-next").click(),!0;if(32==a.keyCode||83==a.keyCode||87==a.keyCode)return $(".fc-button-today").click(),!0});(function(a){a.fn.updateScheduleRemoveState=
function(){var c=a("#ScheduleContainer button.form-schedule-remove");1<c.length?c.prop("disabled",!1):c.prop("disabled",!0);return!0}})(jQuery);$("#ScheduleContainer").on("click","a.form-toggle",function(){var a=$($(this).attr("href"));a.parent().find("input, select").prop("disabled",!0);a.find("input, select").prop("disabled",!1)});$("#ScheduleContainer").on("click","button.form-schedule-add",function(){var a=$("#ScheduleContainer .panel").length;$("#ScheduleContainer").append('<div class="panel panel-default"> <div class="panel-heading panel-link" data-toggle="collapse" href="#container'+
...
$(this).updateScheduleRemoveState();$(".pickDate").datepicker({weekStart:1,language:"de",todayHighlight:!0,autoclose:!0,orientation:"top center",todayBtn:"linked"})});$("#ScheduleContainer").on("click","button.form-schedule-remove",function(){1<$("#ScheduleContainer button.form-schedule-remove").length&&($(this).parents(".panel").first().remove(),$(this).updateScheduleRemoveState())});$.fn.pulse=function(a){a=$.extend({times:3,duration:"slow"},a);for(var c=0;c<a.times;c++)$(this).animate({opacity:0.65},
a.duration).animate({opacity:1},a.duration).delay(50);return $(this)};$(".alert, .message").css({opacity:0}).animate({opacity:1},600).delay(3500);$(this).queue(function(){$(".alert-success, .alert-info").animate({opacity:"0"},"slow").slideUp(1E3);$(this).dequeue()})});
