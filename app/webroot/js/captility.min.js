...
c=$(".btn-scrollTop").first();b.on("click","button.btn-scrollTop",function(){$("html, body").animate({scrollTop:$("body").offset().top},600)});c.length&&c.offset().top<$(window).height()&&c.hide()});
