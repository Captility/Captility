$mobileMaxWidth=992;function getParameterByName(a,c){a=a.replace(/[\[]/,"\\[").replace(/[\]]/,"\\]");var e=RegExp("[\\?&]"+a+"=([^&#]*)").exec(c);return null==e?"":decodeURIComponent(e[1].replace(/\+/g," "))}$(function(){var a=window.location.hash;a&&$('ul.nav a[href="'+a+'"]').first().tab("show");$(".nav-tabs a").click(function(a){a=$("body").scrollTop();window.location.hash=this.hash;$("html,body").scrollTop(a)})});
...
monthNamesShort:"Jan Feb Mrz Apr Mai Jun Jul Aug Sept Okt Nov Dez".split(" "),dayNames:"Sonntag Montag Dienstag Mittwoch Donnerstag Freitag Samstag".split(" "),dayNamesShort:"So Mo Di Mi Do Fr Sa".split(" "),allDayText:"Ganzt\u00e4gig",buttonText:{today:"Heute",month:"Monat",week:"Woche",day:"Tag"},eventSources:[c],editable:!0,selectable:!0,viewRender:function(a,b){$("#SideCalendar").datepicker("update",new Date(a.start))},eventClick:function(f,b,c){a.set({"content.text":"<p><b>Start:</b> "+f.start+
"<br />"+(f.end&&"<p><b>End:</b> "+f.end+"</p>"||"")+'<a class="btn-m btn-sm btn-default pull-right" name="Bearbeiten" href="captures/edit/'+f.capture_id+'">Bearbeiten</a><a class="btn-m btn-sm btn-default pull-right" name="Anzeigen" href="captures/view/'+f.capture_id+'">Anzeigen</a>',"content.title":f.title,"style.classes":"qtip-bootstrap qtip-"+f.className}).reposition(b).show(b)},eventResizeStart:function(){a.hide()},eventDragStart:function(){a.hide()},viewDisplay:function(){a.hide()},eventDrop:function(a){var b=
new Date(a.start),c=b.getFullYear(),e=b.getDate(),g=b.getMonth()+1,h=b.getHours(),b=b.getMinutes(),d=new Date(a.end),k=d.getFullYear(),l=d.getDate(),m=d.getMonth()+1,n=d.getHours(),d=d.getMinutes();$.post("events/update?id="+a.id+"&start="+c+"-"+g+"-"+e+" "+h+":"+b+":00&end="+k+"-"+m+"-"+l+" "+n+":"+d+":00&allday="+(!0==a.allDay?1:0),function(a){})},eventResize:function(a){var b=new Date(a.start),c=b.getFullYear(),e=b.getDate(),g=b.getMonth()+1,h=b.getHours(),b=b.getMinutes(),d=new Date(a.end),k=
d.getFullYear(),l=d.getDate(),m=d.getMonth()+1,n=d.getHours(),d=d.getMinutes();$.post("events/update?id="+a.id+"&start="+c+"-"+g+"-"+e+" "+h+":"+b+":00&end="+k+"-"+m+"-"+l+" "+n+":"+d+":00",function(a){})}});if($("#calendar").length){var p=getParameterByName("date",window.location.href);p&&$("#calendar").fullCalendar("gotoDate",new Date(p))}});var eventColorValues={colors:["#202020 #3a87ad #f70 #009406 #FFEB00 #FD3E20 #5F43A8 #009B9B #579B00 #FF38D7 #FDFDFD".split(" ")]},eventColorNames="Black Blue Orange Green Yellow Red Purple Indigo Mint Pink White".split(" ");
$(document).ready(function(){$(".colorpalette").colorPalette(eventColorValues).on("selectColor",function(a){$(".selected-color").val(a.color)});$(document).keydown(function(a){if(37==a.keyCode||65==a.keyCode)return $(".fc-button-prev").click(),!1;if(39==a.keyCode||68==a.keyCode)return $(".fc-button-next").click(),!1;if(32==a.keyCode||83==a.keyCode||87==a.keyCode)return $(".fc-button-today").click(),!1});(function(a){a.fn.updateScheduleRemoveState=function(){var c=a("#ScheduleContainer button.form-schedule-remove");
