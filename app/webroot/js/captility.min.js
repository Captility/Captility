...
$(document).ready(function(){$("#SideCalendar, .datepicker").datepicker({format:"dd/mm/yyyy",weekStart:1,todayBtn:!0,language:"de",orientation:"top center",daysOfWeekDisabled:"0,6",calendarWeeks:!0,todayHighlight:!0,selectWeek:!0,todayBtn:"linked"},function(){});$("#SideCalendar").datepicker().on("changeDate",function(b){$("#calendar").length?(console.log("Datepicker: "+b.date),$("#calendar").fullCalendar("gotoDate",new Date(b.date))):window.location.href=".?date="+b.date})});
...
monthNamesShort:"Jan Feb Mrz Apr Mai Jun Jul Aug Sept Okt Nov Dez".split(" "),dayNames:"Sonntag Montag Dienstag Mittwoch Donnerstag Freitag Samstag".split(" "),dayNamesShort:"So Mo Di Mi Do Fr Sa".split(" "),allDayText:"Ganzt\u00e4gig",buttonText:{today:"Heute",month:"Monat",week:"Woche",day:"Tag"},eventSources:[e],editable:!0,selectable:!0,viewRender:function(a,c){console.log("FullCalendar: "+a.start);$("#SideCalendar").datepicker("update",new Date(a.start))},eventClick:function(a,c,e){b.set({"content.text":"<p><b>Start:</b> "+
a.start+"<br />"+(a.end&&"<p><b>End:</b> "+a.end+"</p>"||"")+'<a class="btn-m btn-sm btn-default pull-right" name="Bearbeiten" href="captures/edit/'+a.capture_id+'">Bearbeiten</a><a class="btn-m btn-sm btn-default pull-right" name="Anzeigen" href="captures/view/'+a.capture_id+'">Anzeigen</a>',"content.title":a.title,"style.classes":"qtip-bootstrap qtip-"+a.className}).reposition(c).show(c)},eventResizeStart:function(){b.hide()},eventDragStart:function(){b.hide()},viewDisplay:function(){b.hide()},
eventDrop:function(a){var c=new Date(a.start),b=c.getFullYear(),e=c.getDate(),f=c.getMonth()+1,g=c.getHours(),c=c.getMinutes(),d=new Date(a.end),h=d.getFullYear(),k=d.getDate(),l=d.getMonth()+1,m=d.getHours(),d=d.getMinutes();$.post("events/update?id="+a.id+"&start="+b+"-"+f+"-"+e+" "+g+":"+c+":00&end="+h+"-"+l+"-"+k+" "+m+":"+d+":00&allday="+(!0==a.allDay?1:0),function(a){})},eventResize:function(a){var c=new Date(a.start),b=c.getFullYear(),e=c.getDate(),f=c.getMonth()+1,g=c.getHours(),c=c.getMinutes(),
d=new Date(a.end),h=d.getFullYear(),k=d.getDate(),l=d.getMonth()+1,m=d.getHours(),d=d.getMinutes();$.post("events/update?id="+a.id+"&start="+b+"-"+f+"-"+e+" "+g+":"+c+":00&end="+h+"-"+l+"-"+k+" "+m+":"+d+":00",function(a){})}});if($("#calendar").length){var n=getParameterByName("date",window.location.href);n&&($("#calendar").fullCalendar("gotoDate",new Date(n)),console.log("Query: "+getParameterByName("date",window.location.href)))}});
