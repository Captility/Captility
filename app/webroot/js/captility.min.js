...
-1<window.location.href.indexOf("full_calendar"))$mediaQueryHeader.left="agendaDay,agendaWeek,month",$mediaQueryHeader.center="title",$mediaQueryHeader.right="prev,today,next",$mediaQueryView="month",$hiddenDays=[0];$(document).width()<$mobileMaxWidth&&($mediaQueryView="agendaDay");$(window).bind("resize",function(){$(document).width()<$mobileMaxWidth?$("#calendar").fullCalendar("changeView","agendaDay"):$("#calendar").fullCalendar("changeView","agendaWeek")});var c={url:$appRoot+"events/feed",type:"GET",
cache:!1},a={url:$appRoot+"events/feedMy",type:"GET",cache:!1};$('a[data-toggle="tab"]').on("shown.bs.tab",function(a){$("#calendar").fullCalendar("render");$("#calendar").fullCalendar("render")});$("#GeneralViewFc").click(function(){$(this).parent().hasClass("active")||$("#calendar").fullCalendar("removeEventSource",a).fullCalendar("removeEventSource",c).fullCalendar("addEventSource",c)});$("#MyWeekViewFc").click(function(){$(this).parent().hasClass("active")||$("#calendar").fullCalendar("removeEventSource",
c).fullCalendar("removeEventSource",a).fullCalendar("addEventSource",a)});$("#calendar").fullCalendar({header:$mediaQueryHeader,defaultView:$mediaQueryView,weekMode:"variable",allDaySlot:!1,weekends:!0,firstDay:1,hiddenDays:$hiddenDays,aspectRatio:1.26,firstHour:8,minTime:6,maxTime:22,axisFormat:"HH:mm",formatDate:"dd.MM.yyyy HH:mm:ss",titleFormat:{month:"MMMM yyyy",week:"dd.[ MMM.][yy]{ '&#8211;' dd. MMMM yyyy}",day:"dddd, dd.MM.yyyy"},columnFormat:{month:"ddd",week:"ddd - d.M.",day:"dddd d.M."},
...
b){$("#SideCalendar").datepicker("update",new Date(a.start))},eventClick:function(a,n,c){a.place="H12";c='<ul class="list-group"><li><span class="glyphicon glyphicon-calendar"></span>'+a.datec+' <li><span class="glyphicon glyphicon-time gl-ml"></span>'+a.time+" "+(a.place&&'  <span class="glyphicon glyphicon-map-marker gl-ml"></span>'+a.place+"</li><br/>"||"")+(a.niceEnd&&"<p><b>End:</b> "+a.end+"</p>"||"")+'<li><span class="glyphicon glyphicon-th-list"></span><a href="lectures/view/'+a.Lecture.lecture_id+
'">'+a.Lecture.number+" "+a.Lecture.name+"</a>"+(a.Lecture.link&&'<a href="'+a.Lecture.link+'"> <span class="glyphicon glyphicon-link gl-ms"></span></a>')+'</li><br/><li><span class="glyphicon cp-icon-lecturer"></span><a href="hosts/view/'+a.Host.host_id+'">'+a.Host.name+"</a>"+(a.Host.email&&'<a href="mailto:'+a.Host.email+'"> <span class="glyphicon glyphicon-envelope gl-ms"></span></a>')+(a.Host.contact_email&&'<a href="mailto:'+a.Host.contact_email+'"><span class="glyphicon glyphicon-envelope gl-ms"></span></a>')+
...
a.capture_id+'">Anzeigen';console.log(a);b.set({"content.text":c,"content.title":'<span class="glyphicon glyphicon-film"></span>'+a.title,"style.classes":"qtip-bootstrap qtip-"+a.className}).reposition(n).show(n)},eventResizeStart:function(){b.hide()},eventDragStart:function(){b.hide()},viewDisplay:function(){b.hide()},eventDrop:function(a){var b=new Date(a.start),c=b.getFullYear(),e=b.getDate(),f=b.getMonth()+1,g=b.getHours(),b=b.getMinutes(),d=new Date(a.end),h=d.getFullYear(),k=d.getDate(),l=d.getMonth()+
1,m=d.getHours(),d=d.getMinutes();$.post($appRoot+"events/update?id="+a.id+"&start="+c+"-"+f+"-"+e+" "+g+":"+b+":00&end="+h+"-"+l+"-"+k+" "+m+":"+d+":00&allday="+(!0==a.allDay?1:0),function(a){})},eventResize:function(a){var b=new Date(a.start),c=b.getFullYear(),e=b.getDate(),f=b.getMonth()+1,g=b.getHours(),b=b.getMinutes(),d=new Date(a.end),h=d.getFullYear(),k=d.getDate(),l=d.getMonth()+1,m=d.getHours(),d=d.getMinutes();$.post($appRoot+"events/update?id="+a.id+"&start="+c+"-"+f+"-"+e+" "+g+":"+b+
":00&end="+h+"-"+l+"-"+k+" "+m+":"+d+":00",function(a){})}});if($("#calendar").length){var e=getParameterByName("date",window.location.href);e&&$("#calendar").fullCalendar("gotoDate",new Date(e))}});var eventColorValues={colors:["#202020 #3a87ad #f70 #009406 #FFEB00 #FD3E20 #5F43A8 #009B9B #579B00 #FF38D7 #FDFDFD".split(" ")]},eventColorNames="Black Blue Orange Green Yellow Red Purple Indigo Mint Pink White".split(" ");
...
c=$(".btn-scrollTop").first();b.on("click","button.btn-scrollTop",function(){$("html, body").animate({scrollTop:$("body").offset().top},600)});c.length&&c.offset().top<$(window).height()&&c.hide();$("img.landing-page-thumbnail").click(function(){$(".modal-body").empty();var a=$(this).parent("a").attr("title");$(".modal-title").html(a);$($(this).parents("div").html()).appendTo(".modal-body");$("#LandingPageModal").modal({show:!0}).find(".modal-dialog").css({"max-width":this.naturalWidth+52})})});
